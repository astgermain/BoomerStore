    ...
    <div className="supplements-wrapper">
      <div className="supplements-page">
        ...
        <div className="supplements-middle-banner-container">
          ...
          <iframe width="560" height="315" src="https://www.youtube.com/embed/N9UvLnm1WK0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          <div className="sup-mid-right">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/oqUlAWY5kSs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
        </div>

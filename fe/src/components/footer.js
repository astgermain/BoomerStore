      ...
      <div className="footer-row">
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "row" }}>
            ...
            <svg className="payment-icon" viewBox="0 0 38 24" aria-label="Visa">
...
<div>
            ...
            <svg viewBox="0 0 38 24" aria-label="Elo" className="payment-icon">
            <path
                d="M35 1c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2h32z"
                fill="#fff"
              ></path>
      ...
      <div className="footer-row2">
        <div className="reserve EReg">
          Copyright &copy; 2021 Boomer Store. All Rights Reserved
        </div>
        <div className="footer-links-section">
